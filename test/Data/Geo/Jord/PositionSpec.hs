...
spec :: Spec
spec = do
    describe "Geodetic Position to ECEF Vector" $
        it "transforms geodetic position and height to ECEF vector" $ do
            ...
            let refEcefs =
                    [ ecefVector 5733855.77488171 (-6370998.38026088) 7008137.51062469 wgs84
                    , ecefVector 3194419.14512197 3194419.14512197 4487348.40860601 wgs84
                    , ecefVector 4200996.76974058 172460.32072401 4780102.80780980 wgs84
                    ]
            mapM_ (\(g, e) -> toEcefVector g `ecefShouldBe` e) (zip refGeodetics refEcefs)
    describe "ECEF Vector To Geodetic Position" $
        it "transforms ECEF vector to geodetic position and height" $ do
            ...
            let refEcefs =
                    [ ecefVector 5733855.774881717 (-6370998.380260889) 7008137.510624695 wgs84
                    , ecefVector 3194419.145121972 3194419.145121971 4487348.408606014 wgs84
                    , ecefVector 4200996.769831858 172460.320727757 4780102.807914356 wgs84
                    ]
            mapM_ (\(g, e) -> fromEcefVector e `shouldBe` g) (zip refGeodetics refEcefs)
