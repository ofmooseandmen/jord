...
spec = do
    describe "r2xyz" $
        it "computes the 3 angles about new axes in the xyz-order from rotation matrix" $ do
            ...
            let rm =
                    [ V3 0.7044160264027587 (-6.162841671621935e-2) 0.7071067811865475
                    , V3 0.559725765762092 0.6608381550289296 (-0.5)
                    , V3 (-0.43646893232965345) 0.7479938977765876 0.5000000000000001
                    ]
    ...
    describe "r2xyz" $
        it "computes the 3 angles about new axes in the zyx-order from rotation matrix" $ do
            ...
            let rm =
                    [ V3 0.9254165783983234 1.802831123629725e-2 0.37852230636979245
                    , V3 0.16317591116653482 0.8825641192593856 (-0.44096961052988237)
                    , V3 (-0.3420201433256687) 0.46984631039295416 0.8137976813493738
                    ]
